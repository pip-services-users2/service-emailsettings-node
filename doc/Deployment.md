# Deployment Guide <br/> Email Settings Microservice

Email settings microservice can be used in different deployment scenarios.
...
```javascript
{
    ...
    "dependencies": {
        ....
        "service-emailsettings-node": "^1.0.0",
        ...
    }
}
```
...
var plugin = require('service-emailsettings-node').EmailSettingsSenecaPlugin;
...
or by using [EmailSettingsSenecaClient](https://github.com/pip-services-users2/client-emailsettings-node/NodeClientApiV1.md/#client_seneca)